      ...
      <aside className="sidebar">
        ...
        <nav className="sidebar-nav" aria-label="Main">
          ...
          <div className="nav-group">
            <div className={isReimbursementsActive ? "nav-row active" : "nav-row"}>
              ...
              <button
                type="button"
                className={reimbursementsOpen ? "nav-chevron open" : "nav-chevron"}
                aria-expanded={reimbursementsOpen}
                aria-label={
                  reimbursementsOpen ? "Collapse Reimbursements" : "Expand Reimbursements"
                }
