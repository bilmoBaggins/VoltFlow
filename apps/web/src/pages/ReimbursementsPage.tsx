      ...
      <div className="rb-main">
        <header className="rb-topbar">
          ...
          <div className="rb-topbar-right">
            <button type="button" className="rb-icon-btn" aria-label="Notifications">
              <IconBell />
            </button>
        ...
        <div className="rb-content">
          <section className="rb-queue">
            ...
            <div className="rb-pagination">
              <span className="muted">Showing {pending.length} of {pending.length}</span>
                  ...
                  {STEPS.map((step, i) => {
                    ...
                    return (
                      <div className="rb-step" key={step.key}>
                        {i > 0 && <div className={`rb-step-line step-${state}`} />}
